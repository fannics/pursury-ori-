...
@section('main_content')
    <div class="row stores-import">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
            <div class="panel">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <h2>{{ trans('stores.importer.import_brands') }}</h2>
                            <p>
                                {{ trans('stores.importer.summary') }}
                            </p>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 50px;">
                        <div class="col-xs-12 text-center">
                            <span class="btn btn-success fileinput-button btn-lg" id="upload-btn">
                                ...
                                <span data-loading-text="{{ trans('stores.importer.uploading') }}">{{ trans('brands.importer.select_file') }}</span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{ trans('stores.importer.ongoing_operation') }}</h4>
                </div>
                <div class="modal-body">
                    <div class="infinite-progress">
                        <div class="progress">
                            <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
                                <span class="sr-only">{{ trans('stores.importer.45_complete') }}</span>
                            </div>
                        </div>
                    </div>
