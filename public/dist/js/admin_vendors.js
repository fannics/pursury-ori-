...
var extendRequired = (typeof global_extendRequired === 'undefined') ? 'This field is mandatory' : global_extendRequired;
var extendRemote = (typeof global_extendRemote === 'undefined') ? 'Please, fill out this field.' : global_extendRemote;
var extendEmail = (typeof global_extendEmail === 'undefined') ? 'Please, enter a valid e-mail address.' : global_extendEmail;
var extendURL = (typeof global_extendURL === 'undefined') ? 'Please, enter a valid URL.' : global_extendURL;
var extendDate = (typeof global_extendDate === 'undefined') ?  'Please, enter a valid date.' : global_extendDate;
var extendDateISO = (typeof global_extendDateISO === 'undefined') ? 'Please, enter a valid (ISO) date.' : global_extendDate;
var extendNumber = (typeof global_extendNumber === 'undefined') ? 'Please, enter a valid number.' : global_extendNumber;
var extendDigits = (typeof global_extendDigits === 'undefined') ? 'Please, enter only numbers.' : global_extendDigits;
var extendCreditCard = (typeof global_extendCreditCard === 'undefined') ? 'Please, enter a valid card number.' : global_extendCreditCard;
var extendEqualTo = (typeof global_extendEqualTo === 'undefined') ? 'Please, enter the same value again.' : global_extendEqualTo;
var extendExtension = (typeof global_extendExtension === 'undefined') ? 'Please, enter a value with an allowed extension.' : global_extendExtension;
var extendMaxLength = (typeof global_extendMaxLength === 'undefined') ? "Please, don't enter more than {0} characters." : global_extendMaxLength;
var extendMinLength = (typeof global_extendMinLength === 'undefined') ? "Please, don't enter less than {0} characters." : global_extendMinLength;
var extendRangeLength = (typeof global_extendRangeLength === 'undefined') ? 'Please, enter a value with a length between {0} and {1} characters.' : global_extendRangeLength;
var extendRange = (typeof global_extendRange === 'undefined') ? 'Please, enter a value between  {0} and {1} characters.' : global_extendRange;
var extendMax = (typeof global_extendMax === 'undefined') ? 'Please, enter a value less than or equal to {0}.' : global_extendMax;
var extendMin = (typeof global_extendMin === 'undefined') ? 'Please, enter a value greater than or equal to {0}.' : global_extendMin;
var extendNIFES = (typeof global_extendNIFES === 'undefined') ? 'Please, enter a valid NIF.' : global_extendNIFES;
var extendNIEES = (typeof global_extendNIEES === 'undefined') ? 'Please, enter a valid NIE.' : global_extendNIEES;
var extendCIFES = (typeof global_extendCIFES === 'undefined') ? 'Please, enter a valid CIF.' : global_extendCIFES;

$.extend($.validator.messages, {
	required: extendRequired,
	remote: extendRemote,
	email: extendEmail,
	url: extendURL,
	date: extendDate,
	dateISO: extendDateISO,
	number: extendNumber,
	digits: extendDigits,
	creditcard: extendCreditCard,
	equalTo: extendEqualTo,
	extension: extendExtension,
	maxlength: $.validator.format(extendMaxLength),
	minlength: $.validator.format(extendMinLength),
	rangelength: $.validator.format(extendRangeLength),
	range: $.validator.format(extendRange),
	max: $.validator.format(extendMax),
	min: $.validator.format(extendMin),
	nifES: extendNIFES,
	nieES: extendNIEES,
	cifES: extendCIFES
});
...
//# sourceMappingURL=admin_vendors.js.map
